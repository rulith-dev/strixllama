...
PATCH_ORDER = [
    ...
    "apply_spc_direct_io",          # after it: the reader it replaces is the one that patch leaves      # after apply_spec_timing and friends: anchors in the patched server loop
]
